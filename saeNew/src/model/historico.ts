export class Historico {
  ...
  public sop: string;
  public fr: string;
  public respiracao: string;
  public ventilacaoMecanica: boolean;
  public ventilacaoMecanicaTipo: string;
  public fiO2: string;
  public peep: string;
  public spO2: string;
  public mvPresentes: string;
  public ruidosAdventicios: string;
  public presencaoDeTosse: string;
  public aspiracao;
  ...
  constructor() {
    ...
    this.spO2 = "";
    this.mvPresentes = "";
    this.ruidosAdventicios = "";
    this.presencaoDeTosse = "";
    this.aspiracao;
